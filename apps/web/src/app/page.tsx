...
const copy = {
  fr: {
    ...
    liveRows: [
      { client: "Lead Luma entrant", service: "Appel decouverte Northline", time: "09:00", status: "Confirme" },
  ...
  en: {
    ...
    liveRows: [
      { client: "Lead Luma entrant", service: "Northline discovery call", time: "09:00", status: "Confirmed" },
