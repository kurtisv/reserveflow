...
export async function createBookingRequest(formData: FormData) {
    ...
    const booking = await tx.booking.create({
      data: {
        ...
        contextJson: {
          ...
          originalMessage: bookingRequest.originalMessage,
        },
      },
    });
  ...
  await publishEcosystemEvent({
    ...
    title: "Nouveau rendez-vous recu depuis ReserveFlow",
    description: "Le projet est pret a etre centralise dans ClientHub.",
    payload: {
      phone: result.booking.phone,
      projectType: bookingRequest.projectType,
      budgetRange: bookingRequest.budgetRange,
      originalMessage: bookingRequest.originalMessage ?? bookingRequest.notes,
      quoteId: result.booking.quoteId,
      quoteNumber: bookingRequest.quoteNumber,
      quoteTotal: bookingRequest.quoteTotalCents,
      quoteTotalCents: bookingRequest.quoteTotalCents,
      consultantName: bookingRequest.consultantName,
    ...
    notificationTitle: "Nouveau rendez-vous recu depuis ReserveFlow",
    notificationMessage: "Le projet est pret a etre centralise dans ClientHub.",
    priority: "HIGH",
    actionLabel: "Creer le projet client",
    actionUrl: "/dashboard",
  });
  ...
  await sendEcosystemHandoff(process.env.API_METER_INGEST_URL ?? "https://api-meter.vercel.app/api/ecosystem/ingest", {
    ...
    customerName: result.booking.customerName,
    customerEmail: result.booking.customerEmail,
    title: "Rendez-vous confirme dans ReserveFlow",
    description: "ReserveFlow a transmis le projet a ClientHub.",
    payload: {
      phone: result.booking.phone,
      projectType: bookingRequest.projectType,
      budgetRange: bookingRequest.budgetRange,
